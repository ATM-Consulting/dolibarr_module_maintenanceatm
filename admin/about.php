...
/**
 * \file    maintenanceatm/admin/about.php
 * \ingroup maintenanceatm
 * \brief   About page of module MaintenanceATM.
 */
...
// Translations
$langs->loadLangs(array("errors", "admin", "maintenanceatm@maintenanceatm"));
...
$help_url = '';
$page_name = "MaintenanceATMAbout";

llxHeader('', $langs->trans($page_name), $help_url, '', 0, 0, '', '', '', 'mod-maintenanceatm page-admin_about');
